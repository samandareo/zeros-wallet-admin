...
class EditCurrency extends Component {
    constructor({match}) {
        super();
        this.state={
            coin_name:"",coin_symbol:"",coin_code:"",coin_type:"Token",coin_platform:"",smart_contract:"",coin_decimal:"",
            withdrew_fee:"0.005", fee_currency_name:"",can_deposit:"",can_withdraw:"",explorer:"",
            address_default:"",price:"0",day_change:"0",status:"",swap:"1",
    ...
    async componentDidMount() {
        ...
        await Axios.get(ApiUrl.baseurl+"coin/"+this.state.id)
            .then(res=>{
                if(res.data.error){
                    var a=0
                }else{
                    ...
                    this.setState({
                        ...
                        coin_decimal:res.data[0]['coin_decimal'],
                        withdrew_fee:res.data[0]['fee'], fee_currency_name:res.data[0]['fee_coin'],
                        can_deposit:res.data[0]['deposit'],status:res.data[0]["status"],
    ...
    onSubmitForm=(event)=>{
        ...
        Axios.post(ApiUrl.baseurl+"update-coin", formData)
            .then(res=>{
                if(res.data.success){
    ...
    render() {
        ...
        return (
            <Menu title="Edit update Currency And Coin">
                <h3 className="bg-white title-head"> Edit Currency </h3>
                                ...
                                <form onSubmit={this.onSubmitForm}>
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input type="text" value={this.state.logo_img}  onChange={this.logo_img} className="form-control shadow-none" placeholder=" Image Link "/>
                                        </div>
