...
class Coins extends Component {
    ...
    onDel=(id)=>{
        ...
        if(confirm){
            Axios.post(AppUrl.baseurl+"delete-coin",FormDa)
                .then(res=>{
                    if(res.data.success){
                        ...
                        <td style={{width:"200px"}}>
                            <ul className="list-inline m-0">
                                <li className="list-inline-item">
                                    <Link to={"/currency/edit/"+res.id}className="btn btn-success btn-sm shadow-none rounded-0"
                    ...
                    <div className="row">
                       <div className="col-md-12 p-0 m-0">
                           ...
                           <div className="list bg-white p-2">
                               <div className="taddb">
                                   <Link to="/currency/add" className="btn btn-primary btn-sm pl-5 shadow-none">Add Currency</Link>
