...
class Blog extends Component {
    ...
    componentDidMount() {
        ...
        Axios.get(ApiUrl.baseurl+"all-blog",formd)
            .then(res=>{
                if(res.data.error){
                    var a=0
                }else{
    ...
    onDel=(id)=>{
        ...
        if(confirm){
            Axios.post(AppUrl.baseurl+"delete-blog",FormDa)
                .then(res=>{
                    if(res.data.success){
    ...
    render() {
            ...
            if(countval<=this.state.count){
                return(
                    <tr>
                        ...
                        <td>
                            {res.img?
                                <img style={{height:"30px",width:"30px"}} src={res.img}/>
                                :
                        ...
                        <td>
                            <ul className="list-inline m-0">
                                <li className="list-inline-item">
                                    <Link to={"/blog/edit/"+res.id}className="btn btn-success btn-sm shadow-none rounded-0"
        ...
        return (
            <Menu title="All Blogs">
                <h3 className="bg-white title-head"> News and Blogs ({this.state.data.length})</h3>
                    ...
                    <div className="row">
                        <div className="col-md-12 p-0 m-0">
                            ...
                            <div className="list bg-white p-2">
                                <div className="taddb">
                                    <Link to="/blog/add" className="btn btn-primary btn-sm pl-5 shadow-none">Add Blog </Link>
