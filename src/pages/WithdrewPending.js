...
class WithdrewPending extends Component {
    constructor() {
        super();
        this.state={
    ...
    myPayments=()=>{
        ...
        if(token){
            ...
            Axios.post(AppUrl.baseurl+"all/wpending",fda)
                .then(res => {
                    if (res.data.error) {
                        //this.myPayments()
                    } else {
    ...
    render() {
        ...
        return (
            ...
            <Menu title="All Pending Withdrew ">
                <>
                    <h3 className="bg-white title-head"> All Pending Withdrew  ({this.state.data.length})</h3>
...
export default WithdrewPending;